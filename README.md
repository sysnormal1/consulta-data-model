...
<dependency>
    ...
    <artifactId>consulta-entities</artifactId>
...
Importing an entity
````java
import com.sysnormal.libs.db.entities.integrations.consulta_entities.agents.Agent;
...
## 📚 How to Clone
````bash
git clone https://github.com/sysnormal1/java-db-consulta-integration-entities-library.git
